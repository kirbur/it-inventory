...
export const ProgramsListPage: React.SFC<IProgramsListPageProps> = props => {
  ...
  const concatenateTotalUsers = (data: any) => {
    return (
      <td className={styles.alignLeftAndPadding}>{data.totalUsers} users</td>
    );
  };
    ...
    <div className={styles.programsListMain}>
      ...
      <Table
        ...
        propData={[
          ...
          {
            name: "Office 365",
            renewalDate: "2012/09/11",
            totalUsers: 1,
            cost: 200
          },
          {
            name: "Minecraft",
            renewalDate: "2012/09/13",
            totalUsers: 154,
            cost: 575
          },
          {
            name: "Adobe CC",
            renewalDate: "2010/09/12",
            totalUsers: 16,
            cost: 154
          },
          {
            name: "Atlassian",
            renewalDate: "2014/09/12",
            totalUsers: 15,
            cost: 764
          }
        ]}
        ...
        concatonations={[
          concatenateName,
          concatenateRenewalDate,
          concatenateTotalUsers,
          concatenatedCost
        ]}
      />
    </div>
